...
public class ArithmeticTest {     // Save as "ArithmeticTest.java"
   public static void main(String[] args) {
      int number1 = 98*31; // Declare an int variable number1 and initialize it to 98
      int number2 = 5*17;  // Declare an int variable number2 and initialize it to 5
      ...
      // Print results
      System.out.println("The sum, difference, product, quotient and remainder of "+number1+" and "+number2+" are  "+ sum +" "+difference+" "+product+" "+quotient+" "+remainder+"");      // Print the value of the variable
